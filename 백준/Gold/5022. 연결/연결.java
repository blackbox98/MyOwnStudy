...
public class Main {
    ...
    private static int getDist(Point start1, Point start2, Point end1, Point end2) {
        ...
        int startDist = bfs(start1, start2, end1, end2);
        ...
        int endDist = bfs(end1, end2, start1, start2);
        
        if (startDist == 0 || endDist == 0) return Integer.MAX_VALUE;
        else return startDist + endDist;
    }
    
    private static int bfs(Point start1, Point start2, Point end1, Point end2) {
